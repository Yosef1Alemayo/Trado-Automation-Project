...
class Pre_Condition_Jonathan(Base_Chrome):
    ...
    def login_correctly(self, set_up_chrome):
        ...
        driver.find_element(By.XPATH, PreCondition_Locators.PHONE_FIELD).send_keys('0522578853')
        connect = driver.find_element(By.CSS_SELECTOR, PreCondition_Locators.CONNECT_BUTTON)
        connect.click()
        sms_code = query_for_login_code('0522578853')
        time.sleep(3)
